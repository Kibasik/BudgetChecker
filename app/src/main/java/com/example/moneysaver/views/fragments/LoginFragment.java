...
import com.example.moneysaver.views.activities.BudgetActivity;
...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loginEt = v.findViewById(R.id.log_login_edittext);
        passEt = v.findViewById(R.id.log_password_edittext);
    ...
    public void loginBtnClick() {
        Intent intent = new Intent(AppContext.getAppContext(), BudgetActivity.class);
