...
import com.example.moneysaver.controllers.sharedPreferences.SharedPreferencesHelper;
import com.example.moneysaver.models.db.DBHelper;
import com.example.moneysaver.models.db.DBUsers;
...
public class RegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        regBtn = v.findViewById(R.id.register_button);
        loginEt = v.findViewById(R.id.reg_login_edittext);
        passEt = v.findViewById(R.id.reg_password_edittext);
        rePassEt = v.findViewById(R.id.reg_repassword_edittext);
